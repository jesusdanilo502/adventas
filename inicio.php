    ...
    <div id="wrapper">
        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">AdVentas 2.0</a>
            </div>
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="venta/index.php" target="contenedor">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <a href="compra/index.php" target="contenedor">
                            ...
                            <a href="#">
                                <div class="media">
                                    ...
                                    <div class="media-body">
                                        ...
                                        <p class="small text-muted"><i class="fa fa-clock-o"></i> Consultar Ventas por Fechas</p>
                                        <a href="reportes/reporte_ventas/3_rpt_ventamensual.php" target="contenedor">
                                        <p>Consulta y reporte de Ventas por Fechas...</p></a>
                ...
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li>
                        ...
                        <ul id="mantenimiento" class="collapse">
                            ...
                            <li>
                                <a href="tipo_usuario/index.php" target="contenedor"><i class="fa fa-fw fa-table"></i>Tipo Empleado</a>
                            </li>
                        </ul>
                    </li>
